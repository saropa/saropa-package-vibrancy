...
- **[Saropa Package Vibrancy](https://marketplace.visualstudio.com/items?itemName=saropa.saropa-package-vibrancy)**
  - _Dependency Health Scanner:_ Analyzes Flutter project dependencies for community vibrancy. Queries Pub.dev and GitHub APIs, computes a Vibrancy Score (0–100), and categorizes packages as Vibrant, Quiet, Legacy-Locked, or End of Life — directly in your IDE.
