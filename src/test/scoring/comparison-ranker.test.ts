...
import { rankPackages, resultToComparisonData, isWinnerForDimension } from '../../scoring/comparison-ranker';
import { ComparisonData, VibrancyCategory, DimensionWinner } from '../../types';
