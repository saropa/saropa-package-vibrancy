...
import { DepGraphPackage, parseDepGraphJson } from '../../services/dep-graph';
import {
...
describe('transitive-analyzer', () => {
    ...
    describe('countTransitives', () => {
        it('should count transitives from fixture', () => {
            ...
            const httpInfo = result.find((r: import('../../types').TransitiveInfo) => r.directDep === 'http');
            assert.ok(httpInfo);
    ...
    describe('findSharedDeps', () => {
        ...
        it('should find meta as shared dep in fixture', () => {
            ...
            const meta = shared.find((s: import('../../types').SharedDep) => s.name === 'meta');
            assert.ok(meta);
