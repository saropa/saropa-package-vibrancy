...
import { VibrancyStateManager, STATE_KEYS } from '../../state/vibrancy-state';
...
describe('VibrancyStateManager', () => {
    ...
    describe('initial state', () => {
        ...
        it('should respect enableCodeLens setting', () => {
            manager.dispose();
            setTestConfig('saropaPackageVibrancy', 'enableCodeLens', false);
            manager = new VibrancyStateManager();
    ...
    describe('STATE_KEYS', () => {
        it('should have correct key prefixes', () => {
            assert.ok(STATE_KEYS.hasResults.startsWith('saropaPackageVibrancy.'));
            assert.ok(STATE_KEYS.isScanning.startsWith('saropaPackageVibrancy.'));
            assert.ok(STATE_KEYS.codeLensEnabled.startsWith('saropaPackageVibrancy.'));
        });
    });
